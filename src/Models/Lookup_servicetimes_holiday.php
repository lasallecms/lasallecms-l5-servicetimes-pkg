...
/*
 * LOOKUP_SERVICETIMES_HOLIDAYS IS A LOOKUP TABLE!
 */
...
class Lookup_servicetimes_holiday extends BaseModel
{
    ///////////////////////////////////////////////////////////////////
    //////////////          PROPERTIES              ///////////////////
    ///////////////////////////////////////////////////////////////////
     ...
     * @var string
     */
    public $table = 'lookup_servicetimes_holidays';
    ...
    public function servicetimesCount($id)
    {
        ...
        $record =  DB::table('servicetimes')->where('servicetimes_holidays_id', '=', $id)->get();
        return count($record);
    }
}
