...
/*
 * LOOKUP_SERVICETIMES_SERVICETYPES IS A LOOKUP TABLE!
 */
...
class Lookup_servicetimes_servicetype extends BaseModel
{
    ///////////////////////////////////////////////////////////////////
    //////////////          PROPERTIES              ///////////////////
    ///////////////////////////////////////////////////////////////////
     ...
     * @var string
     */
    public $table = 'lookup_servicetimes_servicetypes';
    ...
    {
        return $this->belongsTo('Lasallecms\Servicetimes\Models\Servicetime');
    }
    ...
    public function foreignKeyCheck($id)
    {
        ...
        return  [
            [ 'related_table' => 'servicetimes', 'count' => $this->servicetimesCount($id) ],
        ];
    }
     ...
     * @return int
     */
    public function servicetimesCount($id)
    {
        // I know eloquent does this, but having trouble so hand crafting using DB
        $record =  DB::table('servicetimes')->where('servicetimes_servicetypes_id', '=', $id)->get();
        return count($record);
    }
}
