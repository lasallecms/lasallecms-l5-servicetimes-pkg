 ...
 */
class AdminServicetimesholidayController extends AdminLookupTableBaseController
{
    ///////////////////////////////////////////////////////////////////
     ...
     */
    public $table_type_plural   = "Servicetimes Holidays";

    /*
     * Lookup table type, in the singular
     */
    public $table_type_singular  = "Servicetimes Holiday";

    /*
     * Lookup table name
     */
    public $table_name           = "lookup_servicetimes_holidays";
     ...
     */
    public $model_class          = "Lookup_servicetimes_holiday";

    /*
     * The base URL of this lookup table's resource routes
     */
    public $resource_route_name   = "luservicetimesholiday";
