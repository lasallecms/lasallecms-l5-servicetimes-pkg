...
namespace Lasallecms\Servicetimes\Formprocessing;
 ...
 */
class UpdateServicetimesFormProcessing extends BaseFormProcessing
{
    /*
     ...
     * @var string
     */
    protected $namespaceClassnameModel = "Lasallecms\Servicetimes\Models\Servicetime";
